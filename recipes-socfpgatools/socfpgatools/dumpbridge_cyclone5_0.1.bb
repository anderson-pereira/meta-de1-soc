...
SRC_URI = "git://github.com/robseb/rstools.git;protocol=https;branch=${BRANCH}"
SRCREV = "${AUTOREV}"
# use  git rev-parse HEAD to update

# This Version is for the Intel Cyclone V SoC-FPGA
COMPATIBLE_MACHINE = 'de1-soc'


inherit cmake

S = "${WORKDIR}/git/FPGA-dumpBridge"
FILES_${PN} += "${bindir}"

do_install() {
    install -d ${D}${bindir}
    install -m 0755 FPGA-dumpBridge ${D}${bindir}
}
